...
$records=mysql_query("select k.kode_pt, k.nama_pt, k.alamat, k.kota, k.kodepost, k.telepon, k.fax, k.email, k.website, k.nama_yayasan, k.ketua_yayasan, k.ketua_pt, k.latitude, k.longitude from kampus k where (select p.nama_prodi from prodi_kampus p where p.kode_pt=k.kode_pt) like '%$nama_prodi%'");
$daftar_kamus=array();
$index_kampus=0;
$object=array();
