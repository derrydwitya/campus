...
$records=mysql_query("select k.kode_pt, k.nama_pt, k.alamat, k.kota, k.kodepost, k.telepon, k.fax, k.email, k.website, k.nama_yayasan, k.ketua_yayasan, k.ketua_pt, k.latitude, k.longitude from kampus k inner join prodi_kampus p on k.kode_pt=p.kode_pt where p.nama_prodi like '%$nama_prodi%'");
$daftar_kamus=array();
$index_kampus=0;
$object=array();
